...
export declare class BotSpecificClient<TBot extends BaseBot> {
    ...
    listParticipants: routes.ListParticipants<TBot>;
    addParticipant: routes.AddParticipant<TBot>;
    getParticipant: routes.GetParticipant<TBot>;
    removeParticipant: routes.RemoveParticipant<TBot>;
