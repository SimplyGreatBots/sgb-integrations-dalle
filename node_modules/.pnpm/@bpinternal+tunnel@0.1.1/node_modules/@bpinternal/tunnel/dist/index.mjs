...
// node_modules/.pnpm/isomorphic-ws@5.0.0_ws@8.13.0/node_modules/isomorphic-ws/browser.js
var ws = null;
...
var ZodCatch = class extends ZodType {
  _parse(input) {
    ...
    const result = this._def.innerType._parse({
      data: ctx.data,
      path: ctx.path,
      parent: __spreadProps(__spreadValues({}, ctx), {
        common: __spreadProps(__spreadValues({}, ctx.common), {
          issues: []
        })
      })
...
// src/types.ts
var tunnelHeaderSchema = mod.union([mod.undefined(), mod.string(), mod.string().array()]);
var tunnelRequestSchema = mod.object({
  type: mod.literal("request").optional(),
  id: mod.string(),
  method: mod.string(),
  path: mod.string(),
  query: mod.string().optional(),
  headers: mod.record(tunnelHeaderSchema).optional(),
  body: mod.string().optional()
});
var tunnelResponseSchema = mod.object({
  type: mod.literal("response").optional(),
  requestId: mod.string(),
  status: mod.number(),
  headers: mod.record(tunnelHeaderSchema).optional(),
  body: mod.string().optional()
});
var helloSchema = mod.object({ type: mod.literal("hello") });
var tailSchema = mod.union([tunnelRequestSchema, helloSchema]);
var headSchema = mod.union([tunnelResponseSchema, helloSchema]);
...
var TunnelTail = class extends TunnelClient {
